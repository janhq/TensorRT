...
def add_arguments(parser):
    ...
    parser.add_argument('--version', type=str, default="1.5", choices=["1.4", "1.5", "2.0-base", "2.0", "2.1-base", "2.1", "xl-1.0",
                                                                       "1.5-dreamshaper_7", "1.5-openjourney_V4", "1.5-meinamix_meinaV11"], help="Version of Stable Diffusion")
